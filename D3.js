...
if (crewMass < 0) {
  console.log("Mass can't be negative!")
...
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let index = 0; index < charactersNames.length; index++) {
    if (femaleCharacters[i].name === charactersNames[index]) {
...
console.log(
  'Hi, my name is ' +
    ...
    ' kg. I was born in ' +
    starWarsCharacters[randomCharacter].birth_year +
    ' and my eyes are ' +
    starWarsCharacters[randomCharacter].eye_color +
    '.'
)
